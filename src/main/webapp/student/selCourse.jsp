...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h5>选课</h5>
            <form name="studentquery" action="/StudentInfo/StudentHandler/queryy/1" method="get">
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <c:forEach var="course" items="${requestScope.courseList}">
                                <tr>
                                    ...
                                    <td><a class="btn btn-default"
                                           href="/StudentInfo/StudentHandler/selcou/${course.cid}"> 选择
                                    </a></td>
                                </tr>
                            </c:forEach>
                        </table>
        ...
        <div class="col-md-6">
            <nav aria-label="Page navigation">
                <ul class="pagination bg-primary">
                    <li>
                        <a href="/StudentInfo/StudentHandler/queryy/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a>
                    </li>
                    <c:if test="${pageInfo.hasPreviousPage }">
                        <li>
                            <a href="/StudentInfo/StudentHandler/queryy/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != pageInfo.pageNum }">
                            <li>
                                <a href="/StudentInfo/StudentHandler/queryy/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a>
                            </li>
                        </c:if>
                    ...
                    <li>
                        <a href="/StudentInfo/StudentHandler/queryy/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a>
                    </li>
                </ul>
            </nav>
        </div>
