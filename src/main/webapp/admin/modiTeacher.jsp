        ...
        <div class="col-md-6">
            ...
            <c:forEach var="teacher" items="${requestScope.teacherList}">
                ...
                <form action="../modityTeac/${teacher.tid}" method="get">
                    <h6>姓名</h6>
                    <input type="text" name="tname" value="${teacher.tname }" class="form-control"
                           onkeyup="this.value=this.value.replace(/[^\u4e00-\u9fa5]/g,'')" maxlength="4"></input>
                    <h6>密&nbsp;&nbsp;码</h6>
                    <input type="password" name="tpassword" class="form-control" value="${teacher.tpassword }"
                           onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"></input>
                    <h6>性别</h6>
                    <c:choose>
                        <c:when test="${teacher.tsex == '男'}">
                            <label class="radio" for="radio1">
                                <input type="radio" name="tsex" value="男" checked id="radio1" data-toggle="radio"
                                       class="custom-radio">
                                <span class="icons">
                            ...
                            <label class="radio" for="radio2">
                                <input type="radio" name="tsex" value="女" id="radio2" data-toggle="radio"
                                       class="custom-radio">
                                <span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
                        ...
                        <c:otherwise>
                            ...
                            <label class="radio" for="radio1">
                                <input type="radio" name="tsex" value="男" id="radio1" data-toggle="radio"
                                       class="custom-radio">
                                <span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
                            ...
                            <label class="radio" for="radio2">
                                <input type="radio" name="tsex" value="女" checked id="radio2" data-toggle="radio"
                                       class="custom-radio">
                                <span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
                    ...
                    <h6>个人简介</h6>
                    <textarea name="introduction" class="form-control" cols="20"
                              rows="6">${teacher.introduction }</textarea>
