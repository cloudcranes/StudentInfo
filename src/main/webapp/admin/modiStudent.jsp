                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="sname" value="${student.sname }" class="form-control"
                                   ...
                                   maxlength="4"></input>
                            <h6>身份证号</h6>
                            <input type="text" name="sidcard" value="${student.sidcard }" class="form-control"
                            ...
                            <c:choose>
                                <c:when test="${student.ssex == '男'}">
                                    <label class="radio" for="radio1">
                                        <input type="radio" name="ssex" value="男" checked id="radio1"
                                    ...
                                    <label class="radio" for="radio2">
                                        <input type="radio" name="ssex" value="女" id="radio2" data-toggle="radio"
                                               class="custom-radio">
                                        <span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
                                ...
                                <c:otherwise>
                                    <label class="radio" for="radio1">
                                        <input type="radio" name="ssex" value="男" id="radio1" data-toggle="radio"
                                               class="custom-radio">
                                        <span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
                                    ...
                                    <label class="radio" for="radio2">
                                        <input type="radio" name="ssex" value="女" checked id="radio2"
                                               data-toggle="radio" class="custom-radio">
                                        <span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
                            ...
                            <h6>密码</h6>
                            <input type="password" name="spassword" value="${student.spassword }" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <h6>年龄</h6>
                            <input type="text" name="sage" value="${student.sage}" class="form-control"
                                   maxlength="2"></input>
