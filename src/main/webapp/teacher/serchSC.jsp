                            ...
                            <c:forEach var="exit" items="${sessionScope.sesList}"
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-default"
                                           href="/StudentInfo/TeacherHandler/looksel/${exit.cid }/${exit.cname}/1">
                                        查看名单 </a></td>
                                    <td><a class="btn btn-default"
                                           href="/StudentInfo/TeacherHandler/endcou/${exit.cid }/${exit.cname}/1">
                                        结课 </a></td>
                                    <td><a class="btn btn-default"
                                           href="/StudentInfo/TeacherHandler/endcougrade/${exit.cid }/${exit.cname}/1">
                                        查询成绩 </a></td>
                                </tr>
                            </c:forEach>
                        </table>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != pageInfo.pageNum }">
                            <li>
                                <a href="/StudentInfo/TeacherHandler/sercsc/${sessionScope.tid }/${page_Num }">${page_Num }</a>
                            </li>
                        </c:if>
