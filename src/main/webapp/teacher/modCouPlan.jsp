                ...
                <form action="../moditycouplan/${cplan.tid }"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="courseclass" value="${cplan.courseclass}" class="form-control"
                                   readOnly/>
                            上课时间
                            ...
                            <label class="checkbox" for="coursetime2">
                                <input type="checkbox" name="coursetime" value="34" id="coursetime2"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                第三四节
                            </label>
                            <label class="checkbox" for="coursetime3">
                                <input type="checkbox" name="coursetime" value="56" id="coursetime3"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                第五六节
                            </label>
                            <label class="checkbox" for="coursetime4">
                                <input type="checkbox" name="coursetime" value="78" id="coursetime4"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                第七八节
                            </label>
                            ...
                            <label class="checkbox" for="courseweek1">
                                <input type="checkbox" name="courseweek" value="1" id="courseweek1"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期一
                            </label>
                            ...
                            <label class="checkbox" for="courseweek2">
                                <input type="checkbox" name="courseweek" value="2" id="courseweek2"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期二
                            </label>
                            ...
                            <label class="checkbox" for="courseweek3">
                                <input type="checkbox" name="courseweek" value="3" id="courseweek3"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期三
                            </label>
                            ...
                            <label class="checkbox" for="courseweek4">
                                <input type="checkbox" name="courseweek" value="4" id="courseweek4"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期四
                            </label>
                            ...
                            <label class="checkbox" for="courseweek5">
                                <input type="checkbox" name="courseweek" value="5" id="courseweek5"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期五
                            </label>
                            ...
                            <label class="checkbox" for="courseweek6">
                                <input type="checkbox" name="courseweek" value="6" id="courseweek6"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期六
                            </label>
                            ...
                            <label class="checkbox" for="courseweek7">
                                <input type="checkbox" name="courseweek" value="7" id="courseweek7"
                                       data-toggle="checkbox" class="custom-checkbox"><span class="icons"><span
                                    class="icon-unchecked"></span><span class="icon-checked"></span></span>
                                星期日
                            </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="tid" value="${sessionScope.tid}" class="form-control"
                                           readonly/>
                                </div>
                            </div>
                            <h6>上课教室 </h6>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="classroom" id="classroom" value="${cplan.classroom}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="credits" class="form-control" value="${cplan.credits}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="period" class="form-control" value="${cplan.period }"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" name="totalnum" class="form-control" value="${cplan.totalnum }"
                                           oninput="value=value.replace(/[^\d]/g,'')" maxlength="2"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" style="margin-top:1rem;"><input type="submit" value="修改"
