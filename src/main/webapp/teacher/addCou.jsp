        ...
        <div class="col-md-6">
            <nav aria-label="Page navigation">
                <ul class="pagination bg-primary">
                    <li>
                        <a href="/StudentInfo/CoursePlanHandler/queryy/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a>
                    </li>
                    <c:if test="${pageInfo.hasPreviousPage }">
                        <li>
                            <a href="/StudentInfo/CoursePlanHandler/queryy/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != pageInfo.pageNum }">
                            <li>
                                <a href="/StudentInfo/CoursePlanHandler/queryy/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a>
                            </li>
                        </c:if>
                    ...
                    <li>
                        <a href="/StudentInfo/CoursePlanHandler/queryy/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a>
                    </li>
                </ul>
            </nav>
        </div>
