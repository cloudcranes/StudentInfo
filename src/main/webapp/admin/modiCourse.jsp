        ...
        <div class="col-md-6">
            ...
            <c:forEach var="course" items="${requestScope.courseList}">
                ...
                <form action="../moditystud/${course.cid}" method="get" name="form1">
                    <h6>课程名称</h6>
                    <input class="form-control" type="text" name="cname" value="${course.cname }"
                           onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="10"></input>
                    <h6>课程简介</h6>
                    <textarea class="form-control" name="cintroduction" cols="20"
                              rows="6">${course.cintroduction }</textarea>
